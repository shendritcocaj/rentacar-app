        ...
        <div className="gap-testimonal">
          <div className="testimonial">
            <p className="section__description">
              ...
              Përveç kësaj, shërbimi ndaj klientëve ishte i shkëlqyeshëm.Jame i
              sigurt qe do ti përdor shërbimet e tyre përsëri!"
            </p>
          ...
          <div className="testimonial">
            <p className="section__description">
              ...
              shkëlqyeshme. Automjeti ishte i përshtatshëm për udhëtimi dhe
              gjithçka ishte në rregull.Përkushtimi i stafit bënë që kjo përvojë
              të jetë e paharrueshme. Do ta rekomandoja me plot besim."
            </p>
            <div className="testimonial-img">
              <img src={ava04} alt="" />
              <div className="testimonial-details">
